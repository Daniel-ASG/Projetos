...
def overview_data(data):
    ...
    f_zipcode = st.sidebar.multiselect(
        "Enter zipcode", data.zipcode.sort_values().unique()
    )
...
def commercial_distribution(data):
    ...
    f_year_built = st.sidebar.slider(
        "Year Built", min_year_built, max_year_built, min_year_built
    )
...
def attributes_distribution(data):
    ...
    f_bedrooms = st.sidebar.selectbox(
        "Max number of bedrooms", data.bedrooms.sort_values().unique()
    )
    f_bathooms = st.sidebar.selectbox(
        "Max number of bathrooms", data.bathrooms.sort_values().unique()
    )
    ...
    f_floors = st.sidebar.selectbox(
        "Max number of floor", data.floors.sort_values().unique()
    )
